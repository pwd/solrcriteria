...
import static org.xume.solrcriteria.criterion.Restrictions.ge;
...
public class GeCriterionTest {
	...
	public void testWithDefaultField() {
		String fragment = ge(term("ipsum sit amet")).toQueryFragment();
		assertThat(fragment, equalTo("([ ipsum TO * ] [ sit TO * ] [ amet TO * ])"));
	}

	@Test
	public void testWithValue() {
		String fragment = ge("lorem", term("ipsum sit amet")).toQueryFragment();
